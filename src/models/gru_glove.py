"""
GRU with GloVe Embeddings for IMDB Sentiment Classification
...
def load_and_preprocess_data():
    ...
    # Preprocess WITHOUT stopword removal for GloVe
...
def build_gru_model(embedding_matrix, vocab_size):
    ...
    print("\n" + "="*80)
    print("Building GRU model with GloVe...")
    print("="*80)
...
def train_model(model, X_train, y_train, X_val, y_val):
    """Train the GRU model."""
    print("\n" + "="*80)
    print("Training GRU + GloVe model...")
    print("="*80)
...
def save_results(model, results, training_time):
    ...
    model_path = RESULTS_DIR / 'model_gru_glove.keras'
    model.save(model_path)
    print(f"Model saved: {model_path}")
    
    results['model'] = 'GRU'
    results['embedding'] = 'GloVe'
    results['training_time'] = float(training_time)
    
    results_path = RESULTS_DIR / 'results_gru_glove.json'
...
def main():
    ...
    print("\n" + "="*80)
    print("GRU + GloVe - IMDB Sentiment Classification")
    ...
    embedding_matrix, vocab_size = create_embedding_matrix(tokenizer, embeddings_index)
    ...
    print("\n" + "="*80)
    print("GRU + GloVe training and evaluation complete!")
    print("="*80)
